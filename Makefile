...
obj_dir/Vlobster_CPU: rtl/lobster.sv emul/main.cpp rtl/cache.sv rtl/alu.sv \
	rtl/execman.sv rtl/mmu.sv
...
build-gcc-lobster128/Makefile: gcc
...
build-binutils-lobster128/Makefile: binutils
